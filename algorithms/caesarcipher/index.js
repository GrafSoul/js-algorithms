...
// D would be replaced by A, E would become B, and so on. The method 
...
let resultOne = caesarCipher("Zoo Keeper", 2);
console.log("resultOne - ", resultOne)

let resultTwo = caesarCipher("Javascript Algorithms are Cool!", 6);
console.log("resultTwo - ", resultTwo)

let resultThree = caesarCipher("The hood under the hood under the hood cap", 34);
console.log("resultThree - ", resultThree)

// resultOne -  Bqq Mggrgt
// resultTwo -  Pgbgyixovz Grmuxoznsy gxk IuurF
// resultThree -  Bpm pwwl cvlmz bpm pwwl cvlmz bpm pwwl kix