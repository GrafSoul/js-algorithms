...
let resultOne = meanMedianMode([9, 10, 23, 10, 23, 9]);
console.log("resultOne -", resultOne);

let resultTwo = meanMedianMode([8, 155, 10, 8, 155, 10]);
console.log("resultTwo -", resultTwo);

let resultThree = meanMedianMode([9, 125, 2, 125, 16, 125]);
console.log("resultThree -", resultThree);

// resultOne - { mean: 14, median: 10, mode: [] }
// resultTwo - { mean: 57.666666666666664, median: 10, mode: [] }
// resultThree - { mean: 67, median: 70.5, mode: [ '125' ] }